...
class TopSongsAdapter(private var itemsList: MutableList<Data>, var interfaceCard : InterfaceCard) : RecyclerView.Adapter<TopSongsAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.card.setOnClickListener{
            interfaceCard.onCardViewClick(it, item.position, item.album.id)
        }
    }
